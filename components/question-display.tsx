...
const thoughtImages = ["/thoughtful-person.png", "/focused-laptop-worker.png", "/animated-conversation.png", "/shutterstock-family-phone.jpg", "/shutterstock_woman_thinking.jpg"]
